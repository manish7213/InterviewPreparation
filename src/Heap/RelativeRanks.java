...
public class RelativeRanks {
    ...
    public String[] findRelativeRanks(int[] score) {
        ...
        System.out.println("Score Array is : {} " + Arrays.toString(score));
        ...
        while (!pq.isEmpty()) {
            int data = pq.poll();
            map.put(data, String.valueOf(count++));
        }
    ...
    public static void main(String[] args) {
        ...
        int[] arr = getData();
        String[] relativeRanks1 = relativeRanks.findRelativeRanks(arr);
        System.out.println("Result is *****************");
        System.out.print("[");
        for (String str : relativeRanks1) {
